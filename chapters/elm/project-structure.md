...
```
The highlighed lines show the nuget packages used in the project. This project uses `Fable.Elmish.React` which used to make React and Elmish play well together. As for `Feliz` it used to write React code, i.e. whatever you use in your `render` functions.
